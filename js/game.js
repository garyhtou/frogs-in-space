...
function preload() {
	...
	this.load.image(
		"ok",
		"https://cdn.glitch.com/a8799410-ced8-4389-b408-e70cb1fd6d7b%2Fokok.png?v=1603015686415"
	);

	this.load.image(
		"main_room",
		"https://cdn.glitch.com/a8799410-ced8-4389-b408-e70cb1fd6d7b%2Fmain_room.png?v=1603000178571"
	);
	this.load.image(
		"main_room_2",
		"https://cdn.glitch.com/a8799410-ced8-4389-b408-e70cb1fd6d7b%2Fmainroom2.png?v=1603008242252"
	);
	this.load.tilemapTiledJSON(
		"map",
		"https://cdn.glitch.com/a8799410-ced8-4389-b408-e70cb1fd6d7b%2Fmap.json?v=1603004716886"
	);
...
function create() {
	...
	game.cursors = this.input.keyboard.addKeys({
	...
	this.anims.create({
		key: "frog_n",
		frames: [
			{ key: "greenFrog", frame: "frog2b.png" },
			{ key: "greenFrog", frame: "frog2.png" },
		],
		frameRate: 10,
		repeat: 2,
	});
	this.anims.create({
		key: "frog_e",
		frames: [
			{ key: "greenFrog", frame: "frog1b.png" },
			{ key: "greenFrog", frame: "frog1.png" },
		],
		frameRate: 10,
		repeat: 2,
	});
	this.anims.create({
		key: "frog_s",
		frames: [
			{ key: "greenFrog", frame: "frog4b.png" },
			{ key: "greenFrog", frame: "frog4.png" },
		],
		frameRate: 10,
		repeat: 2,
	});
	this.anims.create({
		key: "frog_w",
		frames: [
			{ key: "greenFrog", frame: "frog3b.png" },
			{ key: "greenFrog", frame: "frog3.png" },
		],
		frameRate: 10,
		repeat: 2,
	});
...
game.addNewPlayer = function (id, x, y) {
	this.playerMap[id] = this.scene.scenes[0].physics.add.sprite(
		x,
		y,
		"greenFrog",
		"frog1.png"
...
game.openGarden = function (id) {
	...
	if (true) {
		...
		var window = this.scene.scenes[0].add.sprite(
			480,
			300,
			"c_garden",
			"gardenBg.png"
		...
		var rakeButton = this.scene.scenes[0].add
			.sprite(850, 100, "c_garden", "rakeButton.png")
			.setInteractive();
		...
		var handButton = this.scene.scenes[0].add
			.sprite(850, 200, "c_garden", "handButton.png")
			.setInteractive();
		...
		var waterButton = this.scene.scenes[0].add
			.sprite(850, 300, "c_garden", "waterButton.png")
			.setInteractive();
		...
		var seedButton = this.scene.scenes[0].add
			.sprite(850, 400, "c_garden", "seedButton.png")
			.setInteractive();
		...
		var closeButton = this.scene.scenes[0].add
			.sprite(850, 500, "ok")
			.setInteractive();
			...
			for (var i = 0; i < 3; i++) {
				...
				for (var j = 0; j < 3; j++) {
					...
					if (item != "") {
						...
						var my_y = (j + 1) * 50 + 294;
						plants[k][i][j] = this.scene.scenes[0].add
							.sprite(my_x, my_y, "c_garden", item)
							.setInteractive();
						...
						plants[k][i][j].on("pointerdown", function () {
							...
							if (
								tool == 1 &&
								(this.frame.customData.filename == "trash1.png" ||
									this.frame.customData.filename == "trash2.png")
							) {
							...
							if (
								tool == 3 &&
								this.frame.customData.filename == "tilledSoil.png"
							) {
							...
							if (
								tool == 0 &&
								(this.frame.customData.filename == "plant3.png" ||
									this.frame.customData.filename == "plant2.png" ||
									this.frame.customData.filename == "plant1.png" ||
									this.frame.customData.filename == "plant4.png")
							) {
								this.setTexture("c_garden", "tilledSoil.png");
							}
						});
